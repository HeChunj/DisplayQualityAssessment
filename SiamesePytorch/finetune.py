...
def main(config: OmegaConf):
    ...
    if model_path != '':
        ...
        pretrained_dict = model_CKPT['model_state_dict']
    ...
    if True:
        ...
        # 获取loss weights
        with open(config['loss_weights'], "r") as f:
        ...
        for epoch in range(Init_Epoch, Epoch):
            ...
            fit_one_epoch(model_train, model, loss, loss_history, optimizer, epoch, epoch_step,
                          epoch_step_val, gen, gen_val, Epoch, Cuda, fp16, scaler, save_period, save_dir, loss_weights, local_rank)
...
def get_final_output(logs_path: str, config: OmegaConf):
    ...
    config_list = {
        ...
        # "model_path": '/home/hechunjiang/gradio/SiamesePytorch/logs-finetune-4-qingxidu/best_epoch_weights.pth',
        # "model_path": '/home/hechunjiang/gradio/SiamesePytorch/logs-finetune-4-qingxidu/loss_2024_11_22_00_58_38/best_epoch_weights.pth',
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config", type=str, default="/home/hechunjiang/gradio/SiamesePytorch/configs/finetune_config.yaml")
    ...
    logs_path = "/home/hechunjiang/gradio/SiamesePytorch/logs/"
    demo_list = os.listdir(logs_path)
    demo_list = [x for x in demo_list if os.path.isdir(
        os.path.join(logs_path, x))]
    demo_list.sort()
    demo_list = demo_list[-21:] # 取最后21个模型
    now = 0
    ...
    for index in index_list:
        ...
        config[
            'loss_weights'] = f"/home/hechunjiang/gradio/SiamesePytorch/loss_weights/weights_{index}.json"
